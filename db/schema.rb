...
ActiveRecord::Schema.define(version: 20150120055620) do
  ...
  create_table "contacts", force: :cascade do |t|
    ...
    t.string "district_doc_type",     limit: 200
    t.string "email",                 limit: 200
    t.string "enrollment",            limit: 100
    t.string "ext",                   limit: 100
    t.string "first_name",            limit: 100
    t.string "full_name",             limit: 200
    t.string "grade",                 limit: 200
    t.string "high_grade",            limit: 100
    t.string "honorific",             limit: 100
    t.string "last_name",             limit: 100
    t.string "low_grade",             limit: 100
    t.string "phone",                 limit: 100
    t.string "school_name",           limit: 200
    t.string "school_classification", limit: 100
    t.string "school_type",           limit: 100
    t.string "source_filename",       limit: 100
    t.string "state",                 limit: 50
    t.string "title",                 limit: 100
    t.string "unused",                limit: 2000
